...
import br.com.unicamp.inf321.models.BookstoreModel;
...
public class BookStoreTest {
	...
	public void afterTest() throws Exception {
		...
		pic.setAutofit(true);
		pic.writeAll(graph, "screenshots/" + BookStoreTest.class.getSimpleName() + "_graphstream_" + testName.getMethodName() + ".jpg");
	}
	...
	public void runSmokeTest() {
		Result result = new GraphWalkerTestBuilder()
				.addModel(MODEL_PATH,
						new AStarPath(new ReachedVertex("v_UC06_Estoque")), new BookstoreModel())
