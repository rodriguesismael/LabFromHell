...
public class BookstoreAppiumTest {
	public final static Path MODEL_PATH = Paths.get("/br/com/unicamp/inf321/Grupo061.graphml");
	...
	public void beforeTest() {
		...
		graph = new MultiGraph(BookstoreAppiumTest.class.getSimpleName() + "_" + testName.getMethodName());
		graph.display(true);
	...
	public void afterTest() throws Exception {
        ...
        FileUtils.copyFile(scrFile, new File("./screenshots/Android_" + BookstoreAppiumTest.class.getSimpleName() + "_" + testName.getMethodName()+ ".jpg"));
		...
		pic.setAutofit(true);
		pic.writeAll(graph, "screenshots/Graph_" + BookstoreAppiumTest.class.getSimpleName() + "_" + testName.getMethodName() + ".jpg");
	}
	...
	public static void setup() {
		...
		driver.manage().timeouts().implicitlyWait(30, TimeUnit.SECONDS); //seta timeout implicito (sempre vai esperar no minimo 5 segundos pelo elemento na tela)
	}
